                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group row align-items-center">
                            ...
                            <div class="col-sm-8 col-md-9 col-lg-10">
                                <input type="text" class="form-control" id="title" placeholder="휴일근무취소신청">
                            </div>
                        </div>
                        <div class="form-group row align-items-center">
                            <label for="workDay" class="col-sm-4 col-md-3 col-lg-2 col-form-label"><span
                                    class=" require"></span>휴일근무 신청일</label>
                        ...
                        <div class="form-group row align-items-center">
                            ...
                            <div class="col-sm-5">
                                <input type="text" class="form-control" id="expectWorkTime" placeholder="" readonly>
                            </div>
                        </div>
                        <div class="form-group row align-items-center">
