    		...
    		<div class="content inner-wrap">
            	<form class="application-form">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group row align-items-center">
                            <label for="timeWorkName" class="col-sm-4 col-md-3 col-lg-2 col-form-label"><span class="require"></span>시차근무명</label>
                            <div class="col-sm-5 col-md-5 col-lg-5">
                        ...
                        <div class="form-group row">
                            <label for="reason" class="col-sm-4 col-md-3 col-lg-2 col-form-label"><span class="require"></span>비고</label>
