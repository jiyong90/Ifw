                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group row align-items-center">
                            ...
                            <div class="col-sm-8 col-md-9 col-lg-10">
                                <input type="text" class="form-control" id="title" placeholder="자율출퇴근제 신청">
                            </div>
                        </div>
                        <div class="form-group row align-items-center">
                            <label for="workStartDay" class="col-sm-4 col-md-3 col-lg-2 col-form-label"><span
                                    class=" require"></span>시작일</label>
                        ...
                        <div class="form-group row align-items-center">
                            <label for="workEndDay" class="col-sm-4 col-md-3 col-lg-2 col-form-label"><span
                                    class=" require"></span>종료일</label>
                            <div class="col-sm-5 col-md-5 col-lg-5">
                                <div class="input-group date" data-provide="datepicker">
                                    <input type="text" class="form-control " id="workStartDay" placeholder=""
                                        required="" value="">
                                    <div class="input-group-append">
                                        <span class="input-group-text " id="workEndDayAppend"><i
                                                class="far fa-calendar-alt"></i></span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-group row align-items-center">
                            <label for="name" class="col-sm-4 col-md-3 col-lg-2 col-form-label"><span class="require"></span>자율출퇴근명</label>
                            <div class="col-sm-5 col-md-5 col-lg-5">
                        ...
                        <div class="form-group row align-items-center">
                            <label for="avgWorkTime" class="col-sm-4 col-md-3 col-lg-2 col-form-label"><span class="require"></span>근무시간</label>
                            <div class="col-sm-5 col-md-5 col-lg-5">
