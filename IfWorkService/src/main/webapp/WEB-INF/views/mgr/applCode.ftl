	 	...
	 	<div class="ibsheet-wrapper">
			...
			<div class="row no-gutters">
				<div class="col-5 pr-3">
					...
					<div class="inner">
						<div class="sheet_title_wrap clearfix">
							<div class="float-left title">신청서별 수신처</div>
							<ul class="float-right btn-wrap">
...
<script type="text/javascript">
   	$(function() {
		...
		initdata2.HeaderMode = {Sort:1,ColMove:1,ColResize:1,HeaderCheck:0};
	 	...
	 	initdata2.Cols = [
			...
			{Header:"삭제",		Type:"DelCheck",	Hidden:0,	Width:45,	Align:"Center",	ColMerge:0,	SaveName:"sDelete",	Sort:0 },
   			{Header:"상태",		Type:"Status",		Hidden:0 ,	Width:45,	Align:"Center",	ColMerge:0,	SaveName:"sStatus",	Sort:0 },
			{Header:"id",		Type:"Text",		Hidden:1,	Width:100,	Align:"Center",	ColMerge:0,	SaveName:"applRecLineId",	KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:1,	EditLen:100 },
			{Header:"upid",		Type:"Text",		Hidden:1,	Width:100,	Align:"Center",	ColMerge:0,	SaveName:"applCodeId",		KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:1,	EditLen:100 },
			...
			{Header:"순차",		Type:"Int",			Hidden:0,	Width:45,	Align:"Center",	ColMerge:0,	SaveName:"seq",			KeyField:1,	Format:"",	PointCount:0,	UpdateEdit:1,	InsertEdit:1,	EditLen:5 },
		...
		setSheetAutocompleteEmp( "sheet2", "sabun" );
   	...
   	function doAction2(sAction) {
		...
		case "Insert":
			...
			var applCodeId = sheet1.GetCellValue( sheet1.GetSelectRow(), "applCodeId");
			sheet2.SetCellValue(row, "applCodeId" , applCodeId);
			break;
