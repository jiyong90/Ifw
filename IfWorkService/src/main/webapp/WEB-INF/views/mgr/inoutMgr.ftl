...
<script type="text/javascript">
   	$(function() {
		...
		initdata1.Cols = [
			...
			{Header:"관리자|출근",		Type:"Text",	 Hidden:0,	Width:120,	Align:"Center",	 ColMerge:0, SaveName:"chgSdate", 		KeyField:0,	Format:"YmdHms",	PointCount:0,	UpdateEdit:0,	InsertEdit:1,	EditLen:16 },
			{Header:"관리자|퇴근",		Type:"Text",	 Hidden:0,	Width:120,	Align:"Center",	 ColMerge:0, SaveName:"chgEdate",		KeyField:0,	Format:"YmdHms",	PointCount:0,	UpdateEdit:0,	InsertEdit:1,	EditLen:16 },
