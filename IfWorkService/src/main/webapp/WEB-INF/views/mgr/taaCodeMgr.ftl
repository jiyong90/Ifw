...
<script type="text/javascript">
   	$(function() {
		...
		initdata1.Cols = [
			...
			{Header:"신청타입",		Type:"Text",		Hidden:1,	Width:100,	Align:"Center",	ColMerge:0,	SaveName:"requestTypeCd",	KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:0,	EditLen:100 },
