...
<script type="text/javascript">
   	$(function() {
		...
		initdata1.Cols = [
			...
			{Header:"유급여부",	Type:"CheckBox",	Hidden:0,	Width:100,	Align:"Center",	ColMerge:0,	SaveName:"payYn",			KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:1,	InsertEdit:1,	EditLen:100 },
