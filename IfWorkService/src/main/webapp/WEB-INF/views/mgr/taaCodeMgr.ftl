...
<script type="text/javascript">
   	$(function() {
		...
		initdata1.Cols = [
			...
			{Header:"신청타입",		Type:"Combo",		Hidden:0,	Width:100,	Align:"Center",	ColMerge:0,	SaveName:"requestTypeCd",	KeyField:0,	Format:"",		PointCount:0,	UpdateEdit:0,	InsertEdit:1,	EditLen:100 },
