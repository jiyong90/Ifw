package com.isu.ifw.intf.hdngv.controller;
...
import com.isu.ifw.intf.util.CookieUtil;
...
//			mv.setViewName("inout");
	...
	public void autowaySsoLogin(HttpServletRequest req, HttpServletResponse res) throws Exception {
		...
		//mv.addObject("tsId", "hdngv");
		System.out.println("/wtms/hdngvsso!!!!!!!!!!!!!");
		try {
			System.out.println("req !!!!!!!!!!!!!  111");
			Cookie[] getCookie = req.getCookies();
			System.out.println("req !!!!!!!!!!!!! 2222");
			...
			if(getCookie != null){
				...
				System.out.println("getCookie is null !!!!!!!!!!! ");
			}
			...
			res.sendRedirect("https://cloudhr.pearbranch.com/ifw/login/hdngvsso/sso?accessToken="+t+"&p="+encParam);
		}catch(Exception e) {
