...
var orgObj = {
	 ...
	 */
	Down2Image : function() {
		myOrg.saveAsImage( { filename : "org.png", backgroundColor : "white" } );
	},
	/**
	 * 레벨정렬 설정
...
//			email = sheetObj.GetCellValue(i, "email");
			...
			photo = baseURL + "/EmpPhotoOut.do?enterCd=" + enterCd + "&sabun=" + empCd;
...
//			orgJson.fields['email'] = email;
			...
			if (isDual) {
				...
				enterCd = sheetObj.GetCellValue(i, "entercd");
				empCd = sheetObj.GetCellValue(i, "empcd");
				orgJson.fields['photo2'] = baseURL + "/EmpPhotoOut.do?enterCd=" + enterCd + "&sabun=" + empCd;
			}
